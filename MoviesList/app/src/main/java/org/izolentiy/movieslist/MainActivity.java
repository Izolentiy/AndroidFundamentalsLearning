package org.izolentiy.movieslist;
...
//        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
    ...
    private void setupFloatingButton() {
        FloatingActionButton floatingActionButton = findViewById(R.id.activity_main__add_movie);
    ...
    private Movie generateNewMovie() {
        return new Movie("Новый фильм", "Описания пока нет", 0);
    }
